...
Capstone projects and applied AI design
 ...
 • Combined with my independent engineering development (Reinforcement Learning, Isaac Gym, CUDA 13, TensorRT, MuJoCo, ROS2, low-latency control, GPU systems), this forms a dual-track training approach:
